...
import com.persons.finder.application.BioGenerationFailure
import com.persons.finder.application.BioGenerationResult
...
import com.persons.finder.application.CreatePersonService
...
class RealPostgisPersistenceTest {
    ...
    @Autowired
    private lateinit var createPerson: CreatePersonUseCase

    @Autowired
    private lateinit var updateLocation: UpdatePersonLocationUseCase
