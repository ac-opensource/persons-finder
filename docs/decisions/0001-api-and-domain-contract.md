...
from the individual field limits. Generated prose may contribute at most 260
non-placeholder code points, so every accepted grounding fits the 480-code-point
final bio contract.
...
printable ASCII, at most 260 non-placeholder code points, and no forbidden
...
one-to-three-sentence, 480-code-point contract before persistence.
